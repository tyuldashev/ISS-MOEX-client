...
5. Описание функционала в файлах проекта

## Демо

Исключительно в целях популяризации сервисов информационного сервера Московской Биржи и для демонстрации 
реализованного функционала, приложение развернуто по адресу [moex.backtrader.ru](https://moex.backtrader.ru). 
Аналогичную функциональность вы получите после установки и запуска своего приложения на адресе http://127.0.0.1:8050/ 
локального браузера.
...
поле выбора инструмента (в красном).
